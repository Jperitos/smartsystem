document.addEventListener('DOMContentLoaded', () => {
  const floorSelect = document.getElementById('floors');  // matches your select ID
  const floorImageContainer = document.getElementById('floorImageContainer');
